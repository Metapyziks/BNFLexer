...
namespace BNFLexer.Parsers
{
    ...
    {
        protected static readonly IComparer<Node> NodeComparer = Comparer<Node>.Create((a, b) => {
        ...
        public abstract IEnumerable<Node> Parse(String str, int i, bool whitespace, out ParserException exception);
